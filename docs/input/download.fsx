...
Hype only supports the 64 bit platform, so please make sure that you set "x64" as the platform target. For detailed instructions, please see the [installation instructions](http://diffsharp.github.io/DiffSharp/download.html) of DiffSharp, on which Hype depends.
*)